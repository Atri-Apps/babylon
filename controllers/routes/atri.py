...
class Atri:
	def __init__(self, state: Any):
		...
		self.interval_slider = state["interval_slider"]
		self.TextBox58 = state["TextBox58"]
		self.TextBox59 = state["TextBox59"]
		self.interval_input = state["interval_input"]
	...
	@property
	def run_btn(self):
		self._getter_access_tracker["run_btn"] = {}
		return self._run_btn
	@run_btn.setter
	def run_btn(self, new_state):
		self._setter_access_tracker["run_btn"] = {}
		global default_state
		self._run_btn = Flex(new_state, default_state["run_btn"])
	...
	def interval_slider(self):
		self._getter_access_tracker["interval_slider"] = {}
		return self._interval_slider
	@interval_slider.setter
	def interval_slider(self, new_state):
		self._setter_access_tracker["interval_slider"] = {}
		global default_state
		self._interval_slider = Slider(new_state, default_state["interval_slider"])
	...
	def interval_input(self):
		self._getter_access_tracker["interval_input"] = {}
		return self._interval_input
	@interval_input.setter
	def interval_input(self, new_state):
		self._setter_access_tracker["interval_input"] = {}
		global default_state
		self._interval_input = Input(new_state, default_state["interval_input"])
	...
	def _to_json_fields(self):
		return {
			...
			"interval_slider": self._interval_slider,
...
class SlidercustomClass:
	def __init__(self, state, def_state):
		...
		self.minValue: int = get_defined_value(state, def_state, "minValue")
		self.maxValue: int = get_defined_value(state, def_state, "maxValue")
		self.value: int = get_defined_value(state, def_state, "value")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}

	@property
	def minValue(self):
		self._getter_access_tracker["minValue"] = {}
		return self._minValue
	@minValue.setter
	def minValue(self, state):
		self._setter_access_tracker["minValue"] = {}
		self._minValue = state
	@property
	def maxValue(self):
		self._getter_access_tracker["maxValue"] = {}
		return self._maxValue
	@maxValue.setter
	def maxValue(self, state):
		self._setter_access_tracker["maxValue"] = {}
		self._maxValue = state
	@property
	def value(self):
...
class Slider:
	def __init__(self, state, def_state):
		...
		self.onChange = False
		self.onFinish = False
		self.styles: SliderstylesClass = get_defined_value(state, def_state, "styles")
		self.custom: SlidercustomClass = get_defined_value(state, def_state, "custom")
		self._setter_access_tracker = {}
		self._getter_access_tracker = {}
	...
	def styles(self, state):
		self._setter_access_tracker["styles"] = {}
		self._styles = SliderstylesClass(state, self._def_state["styles"])
	@property
	def custom(self):
		self._getter_access_tracker["custom"] = {}
		return self._custom
	...
	def custom(self, state):
		self._setter_access_tracker["custom"] = {}
		self._custom = SlidercustomClass(state, self._def_state["custom"])
	def _to_json_fields(self):
		return {
			"styles": self._styles,
			"custom": self._custom,
