...
class Atri:
	def __init__(self, state: Any):
		...
		self.Video_Upload = state["Video_Upload"]
	...
	def Video_Upload(self):
		self._getter_access_tracker["Video_Upload"] = {}
		return self._Video_Upload
	@Video_Upload.setter
	def Video_Upload(self, new_state):
		self._setter_access_tracker["Video_Upload"] = {}
		global default_state
		self._Video_Upload = Upload(new_state, default_state["Video_Upload"])
	...
	def _to_json_fields(self):
		return {
			...
			"Video_Upload": self._Video_Upload,
